...
// TestGit.cpp : Définit les comportements de classe pour l'application.
//
...
// Seul et unique objet CTestGitApp

CTestGitApp theApp;


// initialisation de CTestGitApp
